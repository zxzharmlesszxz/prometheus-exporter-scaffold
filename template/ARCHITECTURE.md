...
- `internal/__FEATURE_NAME__`
  Standard feature spec glue plus concrete feature extension files for config,
  snapshot gathering, metric descriptors, and typed snapshot-to-metrics behavior.
- `smoke`
